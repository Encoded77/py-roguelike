...
def iron_ring_force(x, y):
    ...
    return Entity(x, y, 'o', libtcod.darker_orange, 'Iron ring of force', equippable=equippable_component,
                  render_order=RenderOrder.ITEM)


def iron_ring_life(x, y):
    equippable_component = Equippable(EquipmentSlots.FINGER, max_hp_bonus=15)
    return Entity(x, y, 'o', libtcod.darker_orange, 'Iron ring of life', equippable=equippable_component,
                  render_order=RenderOrder.ITEM)
